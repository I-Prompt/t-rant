...
- **Persistent left-nav sidebar** (all pages): House Rules, Unwind Links, Emergency Numbers, Dark Pattern Audit, and the Bookmarklet each get their own standing nav slot, with the current page highlighted, rather than being linked from inside a paragraph.
