...
// entry's `lastVerified` to the date you checked it. Every entry below was
// cross-checked against Wikipedia's "List of emergency telephone numbers"
// plus targeted searches for anything that looked off (2026-08-17 pass);
// India's ambulance figure was corrected from 102 to 108 during that pass.
...
export const EMERGENCY_NUMBERS_STATUS = {
  locked: false,
  reason:
    "Linked into the self-harm/in-danger pathway as a secondary option next to findahelpline.com. Every entry was cross-checked against Wikipedia's List of emergency telephone numbers plus targeted searches (2026-08-17); findahelpline.com remains the primary, actively-maintained pointer.",
} as const;
